...
class alg {
	...
	int value(int color) {// ���㵱ǰ���̸���ɫ�ĵ÷�
		SixPoint l = new SixPoint();

		int _value;
		_value = 0;

		for (int i = 0; i < 19; i++) {// ˮƽ����
	...
	boolean hadsix(int color) {// �����Ƿ��д���ɫ������
		int ChessBoardState[][];
...
class SixPoint {// �����ϵ�����6��λ�ö���
	...
	void add(int color) {// �ڶ����м���һ�����ӣ�ͬʱ�������һ��
...
class mypoint implements Serializable {// ��¼���꼰��ɫ
